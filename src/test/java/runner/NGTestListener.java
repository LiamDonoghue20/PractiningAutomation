...
public class NGTestListener implements ITestListener {
    ...
    public void onTestStart(ITestResult iTestResult){
        ...
        //ToDo: Feature - change name so it isnt hardcoded
        features = extentReportUtil.extent.createTest(Feature.class, "dress test");
    }
    ...
    public void onTestFailure(ITestResult iTestResult) {
        ...
        try {
            extentReportUtil.ExtentReportScreenshot("Screenshot1" + iTestResult.getName());
        } catch (IOException e) {
            e.printStackTrace();
        }
